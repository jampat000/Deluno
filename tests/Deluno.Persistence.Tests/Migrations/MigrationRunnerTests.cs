...
public sealed class MigrationRunnerTests
{
    ...
    public async Task Schema_initializers_record_initial_migration_for_each_database()
    {
        ...
        Assert.Equal(19, await ReadScalarAsync<int>(moviesConnection, "SELECT COUNT(*) FROM schema_migrations;"));
        ...
        Assert.Equal(21, await ReadScalarAsync<int>(seriesConnection, "SELECT COUNT(*) FROM schema_migrations;"));
        ...
        Assert.Equal(18, await ReadScalarAsync<int>(jobsConnection, "SELECT COUNT(*) FROM schema_migrations;"));
