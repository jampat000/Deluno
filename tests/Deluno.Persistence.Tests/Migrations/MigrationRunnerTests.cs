...
public sealed class MigrationRunnerTests
{
    ...
    public async Task Schema_initializers_record_initial_migration_for_each_database()
    {
        ...
        Assert.Equal(14, await ReadScalarAsync<int>(moviesConnection, "SELECT COUNT(*) FROM schema_migrations;"));
        ...
        Assert.Equal(15, await ReadScalarAsync<int>(seriesConnection, "SELECT COUNT(*) FROM schema_migrations;"));
        ...
        Assert.Equal(26, await ReadScalarAsync<int>(platformConnection, "SELECT COUNT(*) FROM schema_migrations;"));
        ...
        Assert.Equal(16, await ReadScalarAsync<int>(jobsConnection, "SELECT COUNT(*) FROM schema_migrations;"));
