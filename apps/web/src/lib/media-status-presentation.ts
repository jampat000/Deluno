...
export const MEDIA_STATUS_PRESENTATION: Record<MediaStatus, {
  ...
  unmonitored: { dot: "bg-muted-foreground", compactLabel: "Passive", label: "Not monitored", tone: "border-hairline bg-muted/40 text-muted-foreground", variant: "default" },
...
export const MONITORING_PRESENTATION = {
  // A monitored title is a healthy tracked title. The small-card wrapper adds
  // the contrast needed over artwork; this stays a quiet, solid status dot.
