...
const buttonVariants = cva(
  [
    "inline-flex min-w-0 items-center justify-center gap-2 whitespace-nowrap rounded-[10px] font-sans text-[length:var(--button-font-size)] font-medium leading-none",
