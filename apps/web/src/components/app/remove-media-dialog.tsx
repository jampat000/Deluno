          ...
          <div className="space-y-3 p-6">
            ...
            {hasImportedFiles ? (
              <div className="rounded-lg border border-hairline bg-surface-0 px-4 py-3 text-xs text-muted-foreground">
                ...
                <div className="mt-1 space-y-1 font-mono text-[11px] leading-relaxed">
            ...
            {removalPreview.warnings.length ? (
              <p className="text-xs leading-relaxed text-amber-300">{removalPreview.warnings.join(" ")}</p>
            ) : null}
          </div>
          ...
          <div className="flex items-center justify-between border-t border-hairline bg-surface-1 px-6 py-4">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="bg-red-600 text-white shadow-none hover:brightness-110"
              >
