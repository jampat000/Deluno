...
/// refreshed.
/// </summary>
public sealed class V0010MovieMetadataRefreshRequests : SqliteSqlMigration
{
    public override int Version => 10;

    public override string Name => "movie_metadata_refresh_requests";

    protected override string Sql =>
        """
        ALTER TABLE movie_entries ADD COLUMN metadata_refresh_requested_utc TEXT NULL;
        """;
}
