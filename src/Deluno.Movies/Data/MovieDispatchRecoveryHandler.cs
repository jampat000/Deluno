    ...
    : IDispatchRecoveryHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await catalogRepository.AddImportRecoveryCaseAsync(
            new CreateMovieImportRecoveryCaseRequest(title, "grab-timeout", summary, recommended, detailsJson),
            cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        await catalogRepository.AddImportRecoveryCaseAsync(
            new CreateMovieImportRecoveryCaseRequest(title, "detection-timeout", summary, recommended, detailsJson),
            cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        await catalogRepository.AddImportRecoveryCaseAsync(
            new CreateMovieImportRecoveryCaseRequest(title, "import-timeout", summary, recommended, detailsJson),
            cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        await catalogRepository.AddImportRecoveryCaseAsync(
            new CreateMovieImportRecoveryCaseRequest(title, "import-failed", summary, recommended, detailsJson),
            cancellationToken);
    }
}
