...
/// </summary>
public sealed class V0019SeriesSubtitleMatch : SqliteSqlMigration
{
    public override int Version => 19;

    public override string Name => "series_subtitle_match";

    protected override string Sql =>
        """
        ALTER TABLE episode_subtitle_state ADD COLUMN match_rung INTEGER NOT NULL DEFAULT 0;

        CREATE INDEX IF NOT EXISTS ix_episode_subtitle_state_match_rung
            ON episode_subtitle_state (match_rung);
        """;
}
